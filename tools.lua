...
core.register_tool("rubies:ruby_pickaxe", {
...
core.register_tool("rubies:ruby_shovel", {
	description = ("Ruby Shovel"),
	inventory_image = "ruby_shovel.png",
	wield_image = "ruby_shovel.png",
	tool_capabilities = {
...
core.register_tool("rubies:ruby_axe", {
...
core.register_tool("rubies:ruby_sword", {
